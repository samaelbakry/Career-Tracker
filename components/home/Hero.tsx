        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          <div className="lg:col-span-6 space-y-8 text-left">
            ...
            <p className="text-lg text-[#64748B] max-w-xl leading-relaxed font-normal">
              Keep every application, interview, recruiter contact, and follow-up 
              organized in one beautiful dashboard so you never miss an opportunity.
            </p>

            <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-4">
              <Link href={"/register"} className="flex items-center justify-center gap-2 px-7 py-4 bg-[#1E3A8A] hover:bg-[#172554] text-white font-semibold rounded-2xl shadow-lg shadow-blue-900/10 hover:shadow-xl transition-all duration-300 active:scale-[0.98]">
                <span>Create Account</span>
                <ArrowRight size={18} />
              </Link>

              <Link href={"/login"} className="flex items-center justify-center px-7 py-4 bg-white border border-slate-200 text-[#1E3A8A] hover:bg-slate-50 font-semibold rounded-2xl transition-all duration-300 active:scale-[0.98]">
                Login
              </Link>
            </div>
