...
import CompanyDetailsEmptyStatus from "@/components/emptyCase/CompanyDetailsEmptyStatus";
...
export default function CompanyDetailsPage() {
  ...
  if (isError || !company) {
    return (
    <CompanyDetailsEmptyStatus error={error ?? new Error("Unable to load company details")} isError={isError} />
    );
  }

  const formattedWebsite = company.website?.startsWith("http") ? company.website : `https://${company.website}`;
