      ...
      <PageTransition auth>
        <div className="space-y-6">
          <div className="space-y-3">
            ...
            >
              ...
              <div className="flex-1 pr-6">
                ...
                <p className="text-xs text-slate-500 mt-1 leading-relaxed">
                  Track job applications, organize interview pipelines, and land
                  your next role.
                </p>
              </div>
            ...
            >
              ...
              <div className="flex-1 pr-6">
                ...
                <p className="text-xs text-slate-500 mt-1 leading-relaxed">
                  Post open job opportunities, review applications, and discover
                  top tech talent.
                </p>
              </div>
          ...
          <button
            ...
            className="w-full py-2 px-4 bg-blue-600 hover:bg-blue-700 text-white font-medium text-sm rounded-xl shadow-lg shadow-blue-500/20 active:scale-[0.99] transition-all flex items-center justify-center gap-2 group cursor-pointer"
          >
            <span>Continue</span>
            <ArrowRight
              size={16}
